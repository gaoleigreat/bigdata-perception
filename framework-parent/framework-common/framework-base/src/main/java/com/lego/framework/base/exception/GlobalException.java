...
public class GlobalException {
    ...
    public RespVO handleException(OperateFailException ex) {
        log.error("操作失败:{}", ex);
        return RespVOBuilder.failure(RespConsts.FAIL_RESULT_CODE, ex.getMsg());
    }
    ...
    public RespVO handleException(SessionTimeoutException ex) {
        log.error("登录超时:{}", ex);
        return RespVOBuilder.failure(RespConsts.FAIL_LOGIN_CODE, ex.getMsg());
    }
    ...
    public RespVO handleException(CallTimeoutException ex) {
        log.error("调用失败:{}", ex);
        return RespVOBuilder.failure(RespConsts.ERROR_CALLTIMEOUT_CODE, ex.getMsg());
    }
    ...
    public RespVO handleException(ServerException ex) {
        log.error("服务异常:{}", ex);
        return RespVOBuilder.failure(RespConsts.ERROR_SERVER_CODE, ex.getMsg());
    }
