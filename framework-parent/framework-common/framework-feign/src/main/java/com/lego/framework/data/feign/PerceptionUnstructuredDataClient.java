...
@FeignClient(value = "file-service", path = "/perceptionUnstructuredData", fallbackFactory = PerceptionUnstructuredDataClientFallback.class, configuration = MultipartSupportConfig.class)
